...
api_id = int(os.environ.get("11964494512"))
api_hash = os.environ.get("8ebf83ab11964494512a21f6a83fd639")
bot_token = os.environ.get("6647759851:AAGprTykEUtZmwk4mwYPhj43rjCd0fBR000")
...
async def start(event):
  await event.reply("Hi I'm @ElectraTagger I was created to search all contacts in chat.\nMerhaba! Grubunuzdaki Kullanıcıları Etiketlemek İçin Yaratıldım. Beni Grubunuza Ekleyin ve Gerisini Bana Bırakın.",
                    buttons=(
                      [Button.url('➕Beni Bir Gruba Ekle➕', 'http://t.me/PalmasTaggerBot?startgroup=a'),],
                      [ Button.url('🔥Grup', 'https://t.me/SohbetGaribanlarTr'),],
                      [ Button.url('🔥sahip ', 'https://t.me/thisisfork'),],
                      [  Button.url('🔥Reklam ', 'https://t.me/thisisfork'),],
...
❕ Yalnızca yöneticileri bu komutları kullanabilir."""
  await event.reply(helptext,
                    buttons=(
                      [Button.url('➕Beni Bir Gruba Ekle➕', 'https://t.me/PalmasTaggerbot?startgroup=a'),
...
print(">> Bot çalıyor merak etme 👮‍♂️ @thisisfork bilgi alabilirsin <<")
